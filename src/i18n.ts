...
const messages: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'options.finalize': '确认完成，请输出最终版本的 PRD、Tech Spec 和 Design Spec',
    'empty.title': '准备开始产品规划',
    'empty.step1': '产品经理收集需求',
    'empty.step2': '生成 PRD、技术方案和设计规范',
  ...
  en: {
    ...
    'options.finalize': 'Confirmed. Please output the final PRD, Tech Spec, and Design Spec.',
    'empty.title': 'Ready to Plan',
    'empty.step1': 'PM gathers requirements',
    'empty.step2': 'Generate PRD, Tech Spec, and Design Spec',
    ...
    'crew.pm.tag': 'PM',
    'crew.tl.tag': 'TL',
    'crew.des.tag': 'Designer',
    'agent.pm': 'Product Manager',
    'agent.dev': 'Tech Lead',
    'agent.des': 'Product Designer',
    'locale.name': 'English',
